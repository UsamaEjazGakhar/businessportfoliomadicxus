...
const paramedicalFeeStructureMLTSubmissionSchema = z.object({
...
export async function GET(req: NextRequest) {
  try {
    ...
    const forms = await prisma.paramedicalFeeStructureMLTSubmission.findMany({
...
export async function POST(req: NextRequest) {
  try {
    ...
    const validatedData = paramedicalFeeStructureMLTSubmissionSchema.parse(body);

    const form = await prisma.paramedicalFeeStructureMLTSubmission.create({
      data: validatedData,
    });
